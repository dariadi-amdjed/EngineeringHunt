...
export function OpenSourcePage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      {/* Hero */}
      <div className="mb-10">
        <div className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-accent-200 bg-accent-50 px-3 py-1 text-[11px] font-medium text-accent-600">
      ...
      <section className="mb-10 rounded-2xl border border-stone-200/80 bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-[16px] font-semibold text-stone-900">
          Why open-source engineering resources matter
        </h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-stone-50 p-4">
            <h3 className="mb-1 text-[13px] font-semibold text-stone-900">Accessibility</h3>
          ...
          <div className="rounded-xl bg-stone-50 p-4">
            <h3 className="mb-1 text-[13px] font-semibold text-stone-900">Transparency</h3>
            <p className="text-[12px] leading-relaxed text-stone-500">
          ...
          <div className="rounded-xl bg-stone-50 p-4">
            <h3 className="mb-1 text-[13px] font-semibold text-stone-900">Community</h3>
            <p className="text-[12px] leading-relaxed text-stone-500">
      ...
      <section className="mb-10 rounded-2xl border border-accent-200/50 bg-accent-50/30 p-6">
        <div className="flex items-start gap-4">
          <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-accent-100">
            <span className="flex h-6 w-6 items-center justify-center rounded bg-accent-500 text-[9px] font-bold text-white">
              EH
            </span>
          </div>
          <div>
            ...
            <div className="mt-3 flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-lg border border-stone-200 bg-white px-4 py-2 text-[13px] font-medium text-stone-700 no-underline shadow-sm transition-all hover:shadow-md"
              >
              ...
              <Link
                to="/submit"
                className="inline-flex items-center gap-1.5 text-[13px] font-medium text-accent-600 no-underline hover:text-accent-700"
              >
                Submit a resource
