  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden border-b border-slate-200 bg-white grid-canvas">
        ...
        <div className="absolute left-4 top-16 font-mono text-[0.55rem] uppercase tracking-widest text-slate-300 sm:left-6 sm:top-20">
          [ 01 // HERO ]
        </div>
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 lg:py-28">
          ...
          <div className="mt-4 flex items-center justify-center gap-4 text-[0.6rem] text-slate-400">
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-center gap-8 px-4 py-4 sm:px-6">
          {stats.map((stat) => (
            <div key={stat.label} className="flex items-center gap-2 text-[0.65rem] text-slate-500">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h2 className="mt-1 text-lg font-bold text-slate-900">Browse by domain</h2>
          </div>
          <Link
            to="/categories"
            className="flex items-center gap-1 text-[0.65rem] font-medium text-blue-600 no-underline hover:text-blue-700"
          >
      ...
      <section className="mx-auto max-w-6xl px-4 pb-14 sm:px-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h2 className="mt-1 text-lg font-bold text-slate-900">Featured tools</h2>
          </div>
          <Link
            to="/explore"
            className="flex items-center gap-1 text-[0.65rem] font-medium text-blue-600 no-underline hover:text-blue-700"
      ...
      <section className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14 text-center sm:px-6">
          ...
          <h2 className="mt-2 text-xl font-bold text-slate-900">Know a tool we're missing?</h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
            Submit a website to help fellow engineers discover the best tools.
          </p>
          <Link
            to="/submit"
            className="mt-4 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white no-underline transition-colors hover:bg-blue-700"
          >
            Submit a website
