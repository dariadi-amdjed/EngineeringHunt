  ...
  if (!website) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6">
        ...
        <h1 className="mt-3 text-xl font-bold text-slate-900">Website not found</h1>
    ...
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6">
      ...
      <div className="mt-6 flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-[0.75rem] text-slate-500">{website.description}</p>
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-[0.7rem] font-medium text-white no-underline transition-colors hover:bg-blue-700"
        >
          Visit Website
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="mb-3 text-[0.75rem] font-semibold text-slate-900">About</h2>
            <p className="text-[0.7rem] leading-relaxed text-slate-600">{website.longDescription}</p>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h2 className="text-[0.75rem] font-semibold text-slate-900">Live Preview</h2>
            </div>
        ...
        <div className="space-y-4">
          {/* Meta */}
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            <h3 className="mb-3 text-[0.65rem] font-semibold uppercase tracking-wider text-slate-400">
              Details
            </h3>
            <dl className="space-y-3 text-[0.7rem]">
              ...
              <div className="flex items-center justify-between">
                ...
                <dd className="flex items-center gap-1.5">
                  {website.platform.map((p) => (
                    <span key={p} className="flex items-center gap-1 rounded bg-slate-100 px-1.5 py-0.5 text-[0.6rem] font-medium capitalize text-slate-600">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <Link
              ...
              className="inline-block rounded-md bg-slate-100 px-2 py-1 text-[0.6rem] font-medium text-slate-600 no-underline transition-colors hover:bg-slate-200"
            >
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {website.tags.map((tag) => (
                <span
                  key={tag}
                  className="flex items-center gap-1 rounded-md bg-slate-100 px-2 py-1 text-[0.6rem] text-slate-500"
                >
      ...
      {relatedWebsites.length > 0 && (
        <div className="mt-10">
          <h2 className="mb-4 text-lg font-bold text-slate-900">Related tools</h2>
